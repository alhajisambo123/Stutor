...
// import { Image as ImageType } from "@/models/course";
// import { FaArrowLeft, FaArrowRight } from "react-icons/fa";
// import { MdCancel } from "react-icons/md";

// const CoursePhotoGallery: FC<{ photos: ImageType[] }> = ({ photos }) => {
...
//             <Image
//               src={photos[0].url}
//               alt={`Course Photo ${currenPhotoIndex + 1}`}
...
//                 alt={`Course Photo ${maximumVisiblePhotos}`}
//                 className="img"
//               />
...
// export default CoursePhotoGallery;
      ...
      <div className="grid md:grid-cols-2 relative gap-5 px-3">
        ...
        <div className="h-[540px] relative rounded-2xl overflow-hidden">
          <div className="hidden md:flex justify-center items-center w-full h-full">
            <Image
              src={photos[0].url}
              alt={`Course Photo ${currentPhotoIndex + 1}`}
              className="cursor-pointer"
              fill
        ...
        {showModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90">
            <div className="relative h-[75vh] w-[90vw] md:w-[70vw]">
              <Image
                src={photos[currentPhotoIndex].url}
                alt={`Course Photo ${currentPhotoIndex + 1}`}
                fill
