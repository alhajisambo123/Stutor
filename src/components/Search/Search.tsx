      ...
      <div className="container mx-auto flex gap-4 dark:text-[#ffffffea] flex-wrap justify-between items-center">
        ...
        <div className="w-full md:1/3 lg:w-auto mb-4 md:mb-0  ">
          ...
          <input
            ...
            className=" px-4 py-3 rounded  dark:bg-black focus:outline-none placeholder:text-gray-600 dark:placeholder:text-white "
            value={searchQuery}
        ...
        <button
          className="px-4 py-3 bg-white rounded   dark:bg-black focus:outline-none placeholder:text-gray-600 dark:placeholder:text-white"
          type="button"
